...
public class Horario extends Empregado {
	...
	public Horario(String nome, String nrDocto, double rendimento, double salario, double horas) {
		...
		if(salario < 0.0)
		{
			throw new IllegalArgumentException("Salário Mensal deve ser maior que zero.");		//Mensagem de Erro
		}
		
		if(horas < 0.0) 
		{
			throw new IllegalArgumentException("Número de Horas deve ser maior que zero.");		//Mensagem de Erro
		}
